...
public class AddElementInArray {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(addElemInArr(arrString, "four")));
        System.out.println(Arrays.toString(addElemInArray(arrString,"four","five","six")));
