...
public class QueueObjects {
    ...
    public static void main(String[] args) {
        ...
        priorityQueue.poll();   // FIFO -- > First in First Out -- > first one was removed - also returns what was removed - once the element is removed, there a new order may happen.
        System.out.println(priorityQueue);
